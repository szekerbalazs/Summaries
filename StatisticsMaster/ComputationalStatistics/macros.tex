...
\newcommand{\SigmaCov}{\mathrel{\stackengine{-2.0ex}{$\Sigma$}{\rule{0.4pt}{2.4ex}}{O}{c}{F}{F}{S}}}
...
\lstset{
    ...
    xleftmargin=2pt,          % Adds left margin
    xrightmargin=2pt,         % Adds right margin
    %linewidth=0.8\textwidth,  % Sets the width of the listing to 80% of text width
...
\lstdefinestyle{RStyle}{
    ...
    rulecolor=\color{gray!80},         % Frame color
    breaklines=true,                   % Line breaking
    captionpos=t,                      % Caption position (top)
    escapeinside={(*@}{@*)},           % Escape inside code
    morekeywords={*,function,library,require,if,else,for,while,return}, % R keywords
